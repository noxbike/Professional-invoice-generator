        ...
        <div className="flex flex-col justify-center items-center text-black bg-gray-50 min-h-screen">
            ...
            <form className="min-w-md p-8 bg-white shadow-md rounded-xl border border-gray-100">
                <div className="grid gap-6 mb-6 md:grid-cols-1">
                    ...
                    <button type="button" className="w-full py-2.5 text-base font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
                    </div>
                </div>
