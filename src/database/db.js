...
db.exec("CREATE TABLE IF NOT EXISTS entreprises (id INTEGER PRIMARY KEY AUTOINCREMENT, logo TEXT, company_name TEXT, address_complete TEXT, postal_code TEXT,  city TEXT, country TEXT DEFAULT 'FRANCE', tva_number TEXT, siret_number TEXT UNIQUE, mention_rcs TEXT, phone TEXT, user_id INTEGER, FOREIGN KEY (user_id) REFERENCES users (id))")
